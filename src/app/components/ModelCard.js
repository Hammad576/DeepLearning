  ...
  return (
    <Link href={href}>
      <motion.div
        ...
        className="bg-[#1e1e2f] rounded-lg overflow-hidden border border-slate-800 hover:border-red-500 transition-all group shadow-md hover:shadow-lg hover:cursor-pointer"
      >
        {/* Model Image */}
